...
const pages = [
  { label: "GitHub", url: "https://github.com/Nitish-N07" },
  { label: "LinkedIn", url: "https://www.linkedin.com/in/nitish-reddy-nandyala-ba6723248/" },

  { label: "Email", url: "mailto:nitishreddynandyala@gmail.com" },
]
