...
const mockData = {
  text: "nitish reddy should be hired for the Engineering Management role because he has a successful track record of managing high-performing teams, implementing strategic solutions, and mitigating risks. He is skilled in data-driven decision-making, collaboration with product teams, and mentorship. Additionally, he has experience leading engineer book clubs, coaching test engineers, and modernizing monitoring infrastructure. Nandyala's expertise and passion for continuous improvement make him a valuable addition to the team.",
  options: [
    "What specific information do you need about Nandyala? ",
    "Can you please clarify what details you're looking for? ",
    "Is there something specific you want to know about Nandyala's qualifications?",
  ],
